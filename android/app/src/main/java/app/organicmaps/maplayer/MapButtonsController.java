...
public class MapButtonsController extends Fragment
{
                           ...
                           @Nullable Bundle savedInstanceState)
  {
    ...
    // GoTr-Ail XX9: keep the Organic bookmarks control alive internally, but never show it.
    ...
    if (mToggleMapLayerButton != null)
    {
      ...
      // GoTr-Ail XX9: layers/settings button is intentionally hidden.
    ...
    if (menuButton != null)
    {
      ...
      // GoTr-Ail XX9: old Organic Maps bottom-right menu is hidden.
